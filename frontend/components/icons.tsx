export const PawIcon = ({ size = 20, color = 'currentColor' }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <ellipse cx="5.5" cy="10" rx="2.5" ry="3.5" fill={color} opacity="0.7" />
    <ellipse cx="18.5" cy="10" rx="2.5" ry="3.5" fill={color} opacity="0.7" />
    <ellipse cx="9" cy="7" rx="2" ry="3" fill={color} opacity="0.7" />
    <ellipse cx="15" cy="7" rx="2" ry="3" fill={color} opacity="0.7" />
    <ellipse cx="12" cy="15" rx="5" ry="5" fill={color} />
  </svg>
);
...
export const TrendUpIcon = ({ size = 14 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const CatIcon = ({ size = 24 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
    <path d="M12 5C8 5 5 8 5 12v4a3 3 0 0 0 3 3h8a3 3 0 0 0 3-3v-4c0-4-3-7-7-7z" />
    <path d="M5 10 L2 6 L5 8" /><path d="M19 10 L22 6 L19 8" />
    <circle cx="9" cy="12" r="1" fill="currentColor" /><circle cx="15" cy="12" r="1" fill="currentColor" />
    <path d="M10 15.5 Q12 17 14 15.5" />
  </svg>
);
