...
public class PetWebController {
    ...
    @RequestMapping(value = {"/pets", "/pets/{petId}", "/users/{userId}/pets"})
    public ResponseEntity<String> handle(HttpServletRequest req) throws IOException {
        ...
        APIGatewayProxyResponseEvent response = petController.handleRequest(event, localContext());
    ...
    public ResponseEntity<String> health() {
        return ResponseEntity.ok("{\"status\":\"ok\",\"service\":\"pet\"}");
    }
    ...
    private com.amazonaws.services.lambda.runtime.Context localContext() {
        return new com.amazonaws.services.lambda.runtime.Context() {
            ...
            public String getLogGroupName() { return "/local/pet"; }
            public String getLogStreamName() { return "local"; }
            public String getFunctionName() { return "pet-local"; }
            public String getFunctionVersion() { return "$LATEST"; }
            public String getInvokedFunctionArn() { return "arn:aws:lambda:local:0:function:pet-local"; }
